...
https://dev.axiomide.com/marketplace/christiangeorgelucas/stix-tools@0.1.0
...
```bash
axiom invoke christiangeorgelucas/stix-tools/ParseBundle --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/stix-tools/0.1.0/ParseBundle \
...
> `axiom inspect node christiangeorgelucas/stix-tools/ParseBundle`.
